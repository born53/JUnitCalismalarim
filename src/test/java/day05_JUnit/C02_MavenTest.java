...
public class C02_MavenTest {
    ...
    public static void main(String[] args) {
        ...
        driver.navigate().back();//geri gelir.test sayfasindan kaynaklanan durum oldugundan geri alip sayfa aciliyor
        ...
        WebElement sonucYazisiElementi= driver.findElement(By.xpath("//div[@id='ui-tabs-1']"));
